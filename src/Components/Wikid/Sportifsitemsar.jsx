export const Sportifsitemsar = [
    {
        id: 1,
        title: "وليد كتلة، النجم التونسي في رياضة المعاقين: بطل بارالمبي",
        date: "",
        content: `<b>مقدمة</b><br/><br/>
        وليد كتلة، المعروف بلقب "النجم التونسي في رياضة المعاقين"، هو رمز للمثابرة والنجاح. وُلِد في 20 يوليو 1985 في تونس، وقد أثبت نفسه كواحد من أعظم الرياضيين البارالمبيين في العالم. مع العديد من الميداليات الذهبية في الألعاب البارالمبية وسجلات عالمية في جعبته، يواصل وليد كتلة التألق على الساحة الدولية، ملهمًا الآلاف من الناس في تونس وخارجها.<br/><br/>
        <b>السيرة الذاتية</b><br/><br/>
        وليد كتلة هو رياضي معاق متخصص في سباقات المسافات المتوسطة، وبشكل أساسي في فئة T34، التي تضم الرياضيين الذين يعانون من شلل دماغي يؤثر على أطرافهم السفلية. منذ بداياته، أظهر موهبة استثنائية وإرادة لا تتزعزع، ليصبح سريعًا شخصية بارزة في ألعاب القوى التونسية.<br/><br/>
        <b>المسيرة والإنجازات</b><br/>
        ترك وليد كتلة بصمة في تاريخ الألعاب البارالمبية بفضل أدائه المذهل على المضمار:<br/><br/>
        ...
        بالإضافة إلى الألعاب البارالمبية، تألق وليد كتلة أيضًا في بطولات العالم لألعاب القوى المعاقين، حيث فاز بالعديد من الميداليات الذهبية في مسابقات 100 م، 200 م، 400 م و800 م T34، مؤكداً مكانته كزعيم في فئته.<br/><br/>
        <b>الأرقام القياسية العالمية</b><br/>
        يمتلك وليد كتلة عدة أرقام قياسية عالمية في فئة T34:<br/>
        ...
        خلال بطولة العالم لألعاب القوى المعاقين في 2023 في باريس، أثبت وليد كتلة مرة أخرى تفوقه بفوزه بالميدالية الذهبية في 800 م T34 بزمن مذهل قدره 1 دقيقة و39 ثانية و23. ساهم هذا الأداء في الميدالية الذهبية السابعة لتونس في هذه المسابقة، مما عزز مكانة البلاد في رياضة المعاقين الدولية.<br/><br/>
        <b>الأثر والإلهام</b><br/>
        بعيدًا عن نجاحاته الرياضية، يعد وليد كتلة مصدر إلهام حقيقي للعديد من الأشخاص. تُظهر مسيرته أن العزيمة والعمل الجاد يمكن أن يتجاوزا جميع العقبات. إنه يمثل الأمل للشباب التونسيين، وخاصة أولئك الذين يعانون من إعاقة، من خلال إثبات أن الحدود يمكن دفعها.<br/>
        لقد لعب وليد كتلة دورًا حيويًا في تعزيز رياضة المعاقين في تونس، مشجعًا العديد من الرياضيين الشباب على الانخراط في الرياضة ومتابعة أحلامهم، بغض النظر عن التحديات التي قد تواجههم.<br/><br/>
        <b>البدايات والدافع</b><br/>
        اكتشف وليد كتلة رياضة ألعاب القوى بالصدفة عندما كان عمره 17 عامًا. جذبت طاقته المتدفقة انتباه ريدها سوداني، مدربه، الذي دعاه لتجربة سباقات الكراسي المتحركة. كانت تلك لحظة حاسمة بالنسبة لوليد، الذي سرعان ما طور شغفًا لهذه الرياضة.<br/>
        ...
        الحياة اليومية لوليد كتلة كرياضي على مستوى عالٍ صارمة. يتدرب بشكل مكثف، غالبًا لعدة ساعات في اليوم، ويشارك في معسكرات تدريبية في الخارج، مثل دبي وبولندا. بالنسبة له، يكمن مفتاح النجاح في الانضباط والتنظيم والتحسين المستمر.<br/>
        ...
        كانت انتصارات وليد كتلة لها تأثير كبير على الرياضة التونسية، خاصة في مجال رياضة المعاقين. لم تلهم نجاحاته فقط جيلًا جديدًا من الرياضيين، بل ساهمت أيضًا في زيادة الاعتراف وتطوير الرياضة للأشخاص ذوي الإعاقة في تونس.<br/>
        كثيرًا ما يشارك وليد كتلة قصصًا عن بداياته الصعبة والعقبات التي واجهها قبل أن يحقق النجاح. انتظر عشر سنوات قبل أن يفوز بميدالياته الذهبية الأولى في الألعاب البارالمبية في لندن عام 2012.<br/><br/>
        <b>اقتباس ملهم:</b><br/>
